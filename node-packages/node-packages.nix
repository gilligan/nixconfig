...
in
{
  ...
  tern = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      sources."acorn-3.3.0"
      sources."enhanced-resolve-2.2.2"
      (sources."glob-3.2.11" // {
        dependencies = [
  ...
  tern-jsx = nodeEnv.buildNodePackage {
    name = "tern-jsx";
    packageName = "tern-jsx";
    version = "1.0.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/tern-jsx/-/tern-jsx-1.0.1.tgz";
      sha1 = "cb33cac10a73d9b9866ecaa96ad9388b4b13e50b";
    };
    dependencies = [
    ...
    meta = {
      description = "Tern plugin adding JSX support";
      homepage = "https://github.com/jacksonrayhamilton/tern-jsx#readme";
      license = "MIT";
    };
    production = true;
  };
